...
setting consisting of 5 experiences of 20 classes each. It performs the third experience starting from the second
experience checkpoints produced by `experiment28_cifar100_resnet32_5_increments_20_classes_800.py`.
"""
...
random.seed(1138)  # set the random see for the creation of the splits in SplitCIFAR100; TODO needs to be different for
