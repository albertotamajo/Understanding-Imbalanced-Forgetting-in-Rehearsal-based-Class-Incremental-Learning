...
experience checkpoints produced by `experiment28_cifar100_resnet32_5_increments_20_classes_2000.py`.
"""
...
random.seed(859)  # set the random see for the creation of the splits in SplitCIFAR100; TODO needs to be different for
