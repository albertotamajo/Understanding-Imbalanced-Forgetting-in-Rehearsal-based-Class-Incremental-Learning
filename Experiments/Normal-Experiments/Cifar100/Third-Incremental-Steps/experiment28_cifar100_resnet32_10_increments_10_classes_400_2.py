...
experience checkpoints produced by `experiment28_cifar100_resnet32_10_increments_10_classes_400.py`.
"""
...
random.seed(42)  # set the random see for the creation of the splits in SplitCIFAR100; TODO needs to be different for
