...
setting consisting of 2 experiences of 50 classes each. Each training is performed with 10000 rehearsal samples.
"""
...
random.seed(23)  # set the random see for the creation of the splits in SplitCIFAR100; TODO needs to be different for
