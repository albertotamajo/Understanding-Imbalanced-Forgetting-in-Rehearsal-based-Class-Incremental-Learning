...
`experiment28_tinyimagenet_resnet18_10_increments_20_classes_800.py`.
"""
...
random.seed(1070)  # set the random see for the creation of the splits in SplitTinyImageNet; TODO needs to be different
