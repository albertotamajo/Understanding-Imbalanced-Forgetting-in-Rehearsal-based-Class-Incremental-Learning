...
`experiment28_tinyimagenet_resnet18_5_increments_40_classes_1600.py`.
"""
...
random.seed(711)  # set the random see for the creation of the splits in SplitTinyImageNet; TODO needs to be different
