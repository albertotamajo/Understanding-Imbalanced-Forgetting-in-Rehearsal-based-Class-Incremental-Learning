...
`experiment28_tinyimagenet_resnet18_10_increments_20_classes_2000.py`.
"""
...
random.seed(633)  # set the random see for the creation of the splits in SplitTinyImageNet; TODO needs to be different
