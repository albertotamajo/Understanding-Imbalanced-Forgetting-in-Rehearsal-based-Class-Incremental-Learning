...
`experiment28_tinyimagenet_resnet18_5_increments_40_classes_8000.py`.
"""
...
random.seed(393)  # set the random see for the creation of the splits in SplitTinyImageNet; TODO needs to be different
