...
class-incremental learning setting consisting of 10 experiences of 20 classes each. It performs the third experience
starting from the second experience checkpoints produced by
`experiment28_tinyimagenet_resnet18_10_increments_20_classes_4000.py`.
"""
...
random.seed(1261)  # set the random see for the creation of the splits in SplitTinyImageNet; TODO needs to be different
