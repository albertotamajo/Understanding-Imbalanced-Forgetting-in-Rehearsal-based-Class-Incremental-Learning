...
class-incremental learning setting consisting of 2 experiences of 100 classes each. Each training is performed with
20000 rehearsal samples.
"""
...
random.seed(1203)  # set the random see for the creation of the splits in SplitTinyImageNet; TODO needs to be different
