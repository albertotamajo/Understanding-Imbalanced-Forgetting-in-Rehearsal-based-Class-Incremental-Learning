...
setting consisting of 10 experiences of 10 classes each. Each training is performed with 1000 rehearsal samples. This
module performs the second experience with different new classes starting from the same first experience checkpoint
produced by `experiment28_cifar100_resnet32_10_increments_10_classes_1000.py`
"""
...
if __name__ == "__main__":
    ...
    for index, (class_order, exp_seeds, rehearsal_seed) in enumerate(zip(CLASS_ORDERS, EXP_SEEDS, REHEARSAL_SEEDS)):
        ...
        runner.run(
            ...
            load_checkpoint=f"experiment{EXP_ID}_cifar100_resnet32_{N_EXPS}_increments_{N_CLASSES_PER_EXP}_classes_0_{N_EXEMPLARS}_experience_0.pth",
