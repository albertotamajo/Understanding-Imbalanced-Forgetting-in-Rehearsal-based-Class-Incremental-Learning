...
setting consisting of 5 experiences of 20 classes each. Each training is performed with 800 rehearsal samples. This
module performs the second experience with different new classes starting from the same first experience checkpoint
produced by `experiment28_cifar100_resnet32_5_increments_20_classes_800.py`
"""
