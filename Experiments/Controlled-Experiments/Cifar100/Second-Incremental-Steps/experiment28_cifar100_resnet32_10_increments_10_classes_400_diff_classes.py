...
setting consisting of 10 experiences of 10 classes each. Each training is performed with 400 rehearsal samples. This
module performs the second experience with different new classes starting from the same first experience checkpoint
produced by `experiment28_cifar100_resnet32_10_increments_10_classes_400.py`
"""
