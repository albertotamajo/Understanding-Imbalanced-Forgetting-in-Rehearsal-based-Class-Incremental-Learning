...
setting consisting of 5 experiences of 20 classes each. It performs the third experience with different new classes
starting from the same second experience checkpoint produced by
`experiment28_cifar100_resnet32_5_increments_20_classes_2000.py`.
"""
