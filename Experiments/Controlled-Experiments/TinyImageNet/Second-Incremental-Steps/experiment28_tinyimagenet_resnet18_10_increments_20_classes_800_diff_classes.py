...
800 rehearsal samples. This module performs the second experience with different new classes starting from the same
first experience checkpoint produced by `experiment28_tinyimagenet_resnet18_10_increments_20_classes_800.py`
"""
