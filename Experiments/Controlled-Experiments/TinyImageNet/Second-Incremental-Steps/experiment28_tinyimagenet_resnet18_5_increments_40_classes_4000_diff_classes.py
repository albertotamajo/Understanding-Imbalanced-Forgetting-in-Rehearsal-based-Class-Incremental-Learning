...
4000 rehearsal samples. This module performs the second experience with different new classes starting from the same
first experience checkpoint produced by `experiment28_tinyimagenet_resnet18_5_increments_40_classes_4000.py`
"""
