...
8000 rehearsal samples. This module performs the second experience with different new classes starting from the same
first experience checkpoint produced by `experiment28_tinyimagenet_resnet18_5_increments_40_classes_8000.py`
"""
...
CLASS_ORDERS = CLASS_ORDERS[:3]
EXP_SEEDS = EXP_SEEDS[:3]
REHEARSAL_SEEDS = REHEARSAL_SEEDS[:3]
