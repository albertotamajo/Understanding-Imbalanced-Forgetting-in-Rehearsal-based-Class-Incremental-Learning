...
`experiment28_tinyimagenet_resnet18_2_increments_100_classes_20000.py`
"""
...
SAVE_PATH = f"experiment{EXP_ID}_tinyimagenet_resnet18_{N_EXPS_TOTAL}_increments_{N_CLASSES_PER_EXP}_classes_{N_EXEMPLARS}_data.pkl"
"""
