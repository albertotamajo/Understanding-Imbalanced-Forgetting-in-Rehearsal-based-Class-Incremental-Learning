...
`experiment28_cifar100_resnet32_10_increments_10_classes_2000_diff_classes.py`
"""
...
CHECKPOINT_FIRST_EXP = (f"experiment{EXP_ID}_cifar100_resnet32_{N_EXPS_TOTAL}_increments_{N_CLASSES_PER_EXP}"
...
SAVE_PATH = f"experiment{EXP_ID}_cifar100_resnet32_{N_EXPS_TOTAL}_increments_{N_CLASSES_PER_EXP}_classes_{N_EXEMPLARS}_diff_classes_data.pkl"
"""
