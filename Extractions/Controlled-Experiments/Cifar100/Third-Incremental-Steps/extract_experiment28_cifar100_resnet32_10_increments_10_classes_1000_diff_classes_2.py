...
`experiment28_cifar100_resnet32_10_increments_10_classes_1000_diff_classes_2.py`
"""
...
CHECKPOINT_THIRD_EXP_PATH = (f"experiment{EXP_ID}_cifar100_resnet32_{N_EXPS_TOTAL}_increments_{N_CLASSES_PER_EXP}" +
...
STORAGE_POL_SEC_EXP_PATH = (f"experiment{EXP_ID}_cifar100_resnet32_{N_EXPS_TOTAL}_increments_{N_CLASSES_PER_EXP}" +
...
SAVE_PATH = f"experiment{EXP_ID}_cifar100_resnet32_{N_EXPS_TOTAL}_increments_{N_CLASSES_PER_EXP}_classes_{N_EXEMPLARS}_diff_classes_data_2.pkl"
"""
